...
const DeviceOrientationController = function ( object, domElement ) {
    ...
    let appState = CONTROLLER_STATE.AUTO;
    ...
    const createRotationMatrix = function () {
        ...
        const worldEuler = new THREE.Euler( - Math.PI / 2, 0, 0, 'YXZ' ); // - PI/2 around the x-axis
